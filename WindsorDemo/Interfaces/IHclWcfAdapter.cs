...
{
    public interface IHclWcfAdapter
    {
        /// <summary>
        /// Converts a Wcf Object to a Hcl compatible object.
        /// </summary>
        /// <param name="wcfObject">The wcf object to be converted</param>
        ...
        object ToHclObject(object wcfObject, Type targetType);
        ...
        object ToWcfObject(object hclObject, Type targetType);
    }
}
